...
page 50109 "Archive Schedule"
{
    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'Archive Schedule';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(InventorySalesOrder; Rec."Order No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Associated Invenotry Sales Order.';
                    Visible = Not IsSimplePage;
    ...
    begin
        ...
        if Rec.CurrentCompany <> SalesTruthMgt.InventoryCompany() then
            if EnvironmentInfo.IsSandbox() then
                Hyperlink('https://businesscentral.dynamics.com/Debug?node=0000c3c7-8bc1-0000-1002-9900836bd2d2&page=50104&company=HEQS%20International%20Pty%20Ltd&dc=0&bookmark=35%3bJAAAAACLAQAAAAJ7%2f0kATgBUADEAMAAxADAAMAAx')
            else
                if EnvironmentInfo.IsProduction() then Hyperlink('https://businesscentral.dynamics.com/?node=0000c3c7-8bc1-0000-1002-9900836bd2d2&page=50109&company=HEQS%20International%20Pty%20Ltd&dc=0&bookmark=35%3bJAAAAACLAQAAAAJ7%2f0kATgBUADEAMAAxADAAMAAx');
