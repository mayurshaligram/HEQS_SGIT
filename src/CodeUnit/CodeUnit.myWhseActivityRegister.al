...
codeunit 50105 "myWhse.-Activity-Register"
{
    ...
    begin
        ...
        // Change With Syntac
        // error(format(WhseActivHeader.Type) + WhseActivHeader."No.");
        ...
        if WhseActivLine.IsEmpty then
            Error(Text003 + 'Testing' + WhseActivLine."No." + 'new');
        CheckWhseItemTrkgLine(WhseActivLine);

        WhseActivHeader.Get(WhseActivLine."Activity Type", WhseActivLine."No.");
        LocationGet(WhseActivHeader."Location Code");
        ...
        if TempWhseActivityLineGrouped.FindSet then
            repeat
                if WhseActivHeader.Type <> WhseActivHeader.Type::Movement then
    ...
    begin
        ...
        repeat
            ...
            if WarehouseActivityLine."Qty. Outstanding" = WarehouseActivityLine."Qty. to Handle" then begin
                ...
                WarehouseActivityLine.Validate(WarehouseActivityLine."Qty. to Handle", QtyDiff);
    ...
    begin
        ...
        WarehouseActivityLine.Validate(WarehouseActivityLine."Qty. Outstanding", QtyDiff);
    ...
    begin
        ...
        case WhseActivLine."Activity Type" of
            WhseActivLine."Activity Type"::"Put-away":
                begin
                    ...
                    WhseJnlLine.SetWhseDoc(WhseActivLine."Whse. Document Type", WhseActivLine."Whse. Document No.", WhseActivLine."Whse. Document Line No.");
        ...
        if WhseActivLine."Serial No." <> '' then
            WhseActivLine.TestField(WhseActivLine."Qty. per Unit of Measure", 1);
    ...
    begin
        ...
        if WhseActivLine."Original Breakbulk" then
            exit;
        ...
        case WhseDocType2 of
            WhseActivLine."Whse. Document Type"::Shipment:
                if (WhseActivLine."Action Type" <> WhseActivLine."Action Type"::Take) and (WhseActivLine."Breakbulk No." = 0) then
                    UpdateWhseShptLine(
                      WhseActivLine."Whse. Document No.", WhseActivLine."Whse. Document Line No.",
                      WhseActivLine."Qty. to Handle", WhseActivLine."Qty. to Handle (Base)", WhseActivLine."Qty. per Unit of Measure");
    ...
    var
        Bin: Record Bin;
    begin
        TempBinContentBuffer.SetFilter(TempBinContentBuffer."Qty. to Handle (Base)", '>0');
        if TempBinContentBuffer.Find('-') then
            repeat
                TempBinContentBuffer.SetRange(TempBinContentBuffer."Qty. to Handle (Base)");
                TempBinContentBuffer.SetRange(TempBinContentBuffer."Bin Code", TempBinContentBuffer."Bin Code");
                TempBinContentBuffer.CalcSums(TempBinContentBuffer.Cubage, TempBinContentBuffer.Weight);
                Bin.Get(TempBinContentBuffer."Location Code", TempBinContentBuffer."Bin Code");
                CheckIncreaseBin(Bin);
                TempBinContentBuffer.SetFilter(TempBinContentBuffer."Qty. to Handle (Base)", '>0');
                TempBinContentBuffer.Find('+');
                TempBinContentBuffer.SetRange(TempBinContentBuffer."Bin Code");
  ...
  "Unit of Measure Code", "Breakbulk No.", "Activity Type", "Lot No.", "Serial No.");
    ...
    begin
     ...
     [WhseActivLine2."Whse. Document Type"::Shipment, WhseActivLine2."Whse. Document Type"::"Internal Pick",
      WhseActivLine2."Whse. Document Type"::Production, WhseActivLine2."Whse. Document Type"::Assembly, WhseActivLine2."Whse. Document Type"::"Internal Put-away"]) and
    (WhseActivLine2."Action Type" <> WhseActivLine2."Action Type"::Take) and (WhseActivLine2."Breakbulk No." = 0)) or
   ((WhseActivLine2."Whse. Document Type" = WhseActivLine2."Whse. Document Type"::Receipt) and (WhseActivLine2."Action Type" <> WhseActivLine2."Action Type"::Place))
then
        ...
        if (WhseActivLine2."Activity Type" = WhseActivLine2."Activity Type"::"Invt. Movement") and (WhseActivLine2."Action Type" <> WhseActivLine2."Action Type"::Take) and
           (WhseActivLine2."Source Document" in [WhseActivLine2."Source Document"::"Prod. Consumption", WhseActivLine2."Source Document"::"Assembly Consumption"])
        then
            NeedRegisterWhseItemTrkgLine := true;
    ...
    begin
        ...
        then begin
            ...
            if SubTotalBase < 0 then begin
                ...
                //   WarehouseActivityLine, WhseActivLine."Item No.", WhseActivLine."Location Code", WhseActivLine."Variant Code",
                //   WhseItemTrackingSetup."Lot No. Required", WhseActivLine."Lot No.",
                //   WhseItemTrackingSetup."Serial No. Required", WhseActivLine."Serial No.");
    ...
    begin
        TempWarehouseActivityLine.SetRange(TempWarehouseActivityLine."Whse. Document Type", WarehouseActivityLine."Whse. Document Type");
        TempWarehouseActivityLine.SetRange(TempWarehouseActivityLine."Whse. Document No.", WarehouseActivityLine."Whse. Document No.");
        TempWarehouseActivityLine.SetRange(TempWarehouseActivityLine."Whse. Document Line No.", WarehouseActivityLine."Whse. Document Line No.");
        TempWarehouseActivityLine.SetRange(TempWarehouseActivityLine."Source Document", WarehouseActivityLine."Source Document");
        ...
        TempWarehouseActivityLine.SetRange(TempWarehouseActivityLine."Action Type", WarehouseActivityLine."Action Type");
        TempWarehouseActivityLine.SetRange(TempWarehouseActivityLine."Original Breakbulk", WarehouseActivityLine."Original Breakbulk");
        TempWarehouseActivityLine.SetRange(TempWarehouseActivityLine."Breakbulk No.", WarehouseActivityLine."Breakbulk No.");
