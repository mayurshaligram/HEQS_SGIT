page 50100 "My Warehouse Pick"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(WhseActivityLines; "My Whse. Pick Subform")
            {
                ApplicationArea = Warehouse;
    ...
    procedure RegisterActivityYesNo(my: Record "Warehouse Activity Header")
    begin
